...
float calibration_factor = -1066560.00; //-106600 worked for my 40Kg max scale setup 
...
void loop() {
  //Serial.print("Weight: ");
  Serial.println(scale.get_units()*1000, 0);  //Up to 3 decimal points *** VALUE MULTIPLIED BY 1000!! made to grams -- for better visuals
