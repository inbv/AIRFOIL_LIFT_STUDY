...
run01= '6L.txt';        # datasets for each run
run02= '14L2516.txt';         
run03= '13L52.txt';
run04= '9L.txt';
run05= '10L.txt';
...
################################################################################
 ...
 f1b= f1(135:246);      # range of proper data (i.e, non-zero)
 f2b= f2;
 f3b= f3;
 f4b= f4(140:252);
 f5b= f5(226:311);
...
subplot(511)
plot(f1b)
title ('1:1 L Lift Force')
xlabel('Sample Number')
ylabel('Lift Force, g, (+/-) 1g')
axis([0 111 2 20])     # the axis can be set for eacth dataset
grid

subplot(512)
plot(f2b)
title ('25:16 L Lift Force')
xlabel('Sample Number')
ylabel('Lift Force, g, (+/-) 1g')
axis([0 67 11 30])
grid
...
subplot(514)
plot(f4b)
title ('4:1 L Lift Force')
xlabel('Sample Number')
ylabel('Lift Force, g, (+/-) 1')
axis([0 112 14 35])
grid

subplot(515)
plot(f5b)
title ('6:1 L Lift Force')
xlabel('Sample Number')
ylabel('Lift Force, g, (+/-) 1g')
axis([0 85 11 35])
grid
...
plot(f1b, 'r', mf1v, 'r', 
   ...
   f4b, 'k', mf4v, 'k',
   f5b, 'm', mf5v, 'm')
axis ([0 120 0 35])              # sets axes for all 5 datasets
xlabel ('Sample Number')
ylabel ('Lift Force, g, (+/-) 1g')
title('Large AOK | Red: 1:1  Green: 25:16  Blue: 5:2 Black: 4:1  Magenta: 6:1')
grid                 
...
histaxis= ([0 35 0 50]);    # sets geneeral axis used for all histograms, so they are comparable

subplot(511)
hist(f1b)
axis(histaxis)  
title('1:1 L Histogram')
...
fig4axis= ([0 7 0 30]);                   # refer to LiftDataProcessingA for more detail on how this works. It is much more simple than the other code.
...
axis(fig4axis)
title('Large AOK LIft Force Summary')
